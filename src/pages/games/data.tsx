...
{
  id: "tanishuv-bingo",
  title: "Tanishuv Bingo",
  description: "Bolalar bir-birlari bilan suhbatlashib, qiziqarli ma'lumotlar topadigan o'yin. Do'stlashish va sinf jamoasini mustahkamlash uchun ajoyib vosita.",
  mainIcon: GiPartyPopper,
  icon: FaChild,
  iconBg: "from-yellow-500 to-orange-500",
  iconColor: "text-yellow-300",
  shadowColor: "yellow",
  available: true,
  path: "/games/bingo",
  bgPattern: "bg-gradient-to-br from-yellow-400 via-orange-400 to-pink-400",
