...
export const gameCards = [
  ...
  id: "iq-game",
  title: "IQ Challenge",
  description: "Test your intelligence with 5 different IQ test categories. Pattern recognition, logic puzzles, matrix reasoning, word logic, and speed thinking.",
  mainIcon: GiBrain,
  icon: FaBrain,
