...
function PictionaryPage() {
  const gameStats = [
    ...
    {
      icon: <GiPaintBrush className="text-2xl text-white" />,
      label: "SO'ZLAR",
      value: "20+ ta",
  ...
  const features = [
    {
      ...
      desc: "Turli ranglar, o'chirg'ich, o'lchamni o'zgartirish",
      color: "from-indigo-500 to-purple-500",
      bgIcon: FaPalette,
      stats: "10+ rang",
    },
    {
      icon: FaGamepad,
      title: "2 jamoa",
      desc: "Bir jamoa chizadi, ikkinchisi topadi",
      color: "from-purple-500 to-pink-500",
      bgIcon: RiTeamFill,
      stats: "A vs B",
    },
    {
      icon: FaCrown,
      title: "Darajalar tizimi",
      desc: "Har 5 raundda qiyinlik oshadi: Easy → Medium → Hard",
      color: "from-pink-500 to-rose-500",
  ...
  const brushSizes = [
    { size: 4, icon: "•", label: "Kichik" },
    { size: 10, icon: "●", label: "O'rtacha" },
    { size: 20, icon: "⬤", label: "Katta" },
  ];
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950 dark:via-purple-950 dark:to-pink-950">
      ...
      <div className="relative z-10 mx-auto min-h-screen w-full max-w-[2000px] px-3 py-4 sm:px-4 sm:py-6 md:px-6 md:py-8 lg:px-8 xl:px-10">
        ...
        <div className="group relative mb-8 transform-gpu overflow-hidden rounded-3xl border-2 border-indigo-400/30 bg-gradient-to-br from-indigo-100/80 via-purple-100/80 to-pink-100/80 dark:from-indigo-900/80 dark:via-purple-900/80 dark:to-pink-900/80 p-6 shadow-2xl backdrop-blur-sm md:p-8 lg:p-10">
          ...
          <div className="absolute bottom-0 left-0 text-4xl opacity-30 animate-bounce delay-200">✏️</div>
          <div className="absolute bottom-0 right-0 text-4xl opacity-30 animate-bounce delay-300">🖼️</div>
          ...
          <div className="relative grid gap-8 lg:grid-cols-2 lg:gap-12 lg:items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="relative inline-block">
                ...
                <div className="relative flex items-center gap-3 rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-800 dark:to-purple-800 px-5 py-2 border-2 border-indigo-400/50 shadow-xl">
                  <GiPaintBrush className="text-indigo-600 dark:text-indigo-300 text-xl animate-spin-slow" />
              ...
              <div className="relative max-w-xl rounded-xl bg-white/50 dark:bg-slate-800/50 p-4 border-2 border-indigo-400/30 backdrop-blur-sm">
                <p className="text-base text-gray-700 dark:text-gray-200 md:text-lg leading-relaxed">
                  2 jamoa. Bir jamoa chizadi, ikkinchisi so'zni topadi. Har bir to'g'ri javob uchun 
                  1 ball. Raund oshgani sari so'zlar qiyinlashadi!
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative transform-gpu overflow-hidden rounded-2xl border-4 border-indigo-400/30 bg-gradient-to-br from-indigo-500 to-purple-500 p-4 shadow-2xl">
                <div className="aspect-[4/3] bg-white rounded-lg border-2 border-white/30 relative overflow-hidden">
                  {/* Example drawing */}
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="30" fill="none" stroke="#6366f1" strokeWidth="4" />
                    <circle cx="40" cy="40" r="5" fill="#6366f1" />
                    <circle cx="60" cy="40" r="5" fill="#6366f1" />
                    <path d="M40 60 Q50 70, 60 60" stroke="#6366f1" strokeWidth="4" fill="none" />
                  </svg>

                  {/* Brush preview */}
                  <div className="absolute bottom-2 left-2 flex gap-1">
                    {brushSizes.map((b, i) => (
                      <div key={i} className="text-xl" style={{ fontSize: b.size }}>{b.icon}</div>
                    ))}
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 p-4">
                  <div className="inline-flex items-center gap-3 rounded-2xl bg-black/50 backdrop-blur-md px-4 py-2 border-2 border-indigo-400/50 shadow-xl">
                    <GiPaintBrush className="text-indigo-300 text-lg animate-pulse" />
                    <span className="text-sm font-black text-white tracking-wider">
                      2 JAMOA · HOLD TO REVEAL · 3 DARAJA
                    </span>
                  </div>
                </div>
              </div>
            ...
            {difficultyLevels.map((level, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">{level.words}</p>
